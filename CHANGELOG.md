...
- Publish the packed package before checking npm for immutable release recovery.
...
- Use a dedicated release verification credential. The release gate no longer shares
  the manual production-proof sender credential.
...
[Unreleased]: https://github.com/creatornader/agent-bridge/compare/v0.7.7...HEAD
[0.7.7]: https://github.com/creatornader/agent-bridge/compare/v0.7.6...v0.7.7
