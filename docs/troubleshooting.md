...
An optional observer installed outside Agent Bridge must not be the only route to a
public host. If it becomes unhealthy, keep clients on the public host and inspect the
observer separately.
