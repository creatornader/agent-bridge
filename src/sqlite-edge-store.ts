...
export class SQLiteEdgeStore {
  ...
  constructor(
    ...
    // The coordinator covers all first-open work, which already has this bounded budget.
    private readonly writeGateWaitMs = SQLITE_INITIALIZATION_BUSY_TIMEOUT_MS,
  ) {
