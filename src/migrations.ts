...
const REQUIRED_COLUMNS = new Map([
  ...
  ["archive_membership_events.sequence", "int8"],
  ["archive_membership_events.request_id", "uuid"],
  ["archive_membership_events.action", "text"],
  ["archive_membership_events.member_role", "name"],
  ["archive_membership_events.actor", "name"],
  ["archive_membership_events.created_at", "timestamptz"],
  ["archive_operations.sequence", "int8"],
  ["archive_operations.request_id", "uuid"],
  ["archive_operations.phase", "text"],
  ["archive_operations.operation", "text"],
  ["archive_operations.workspace", "text"],
  ["archive_operations.client_verified_digest", "bpchar"],
  ["archive_operations.message_count", "int8"],
  ["archive_operations.receipt_count", "int8"],
  ["archive_operations.message_inserted_count", "int8"],
  ["archive_operations.receipt_inserted_count", "int8"],
  ["archive_operations.server_content_binding", "bpchar"],
  ["archive_operations.outcome", "text"],
  ["archive_operations.failure_code", "text"],
  ["archive_operations.published_at", "timestamptz"],
  ["archive_operations.apply", "bool"],
  ["archive_operations.actor", "name"],
  ["archive_operations.created_at", "timestamptz"],
  ["archive_operation_batches.sequence", "int8"],
  ["archive_operation_batches.request_id", "uuid"],
  ["archive_operation_batches.record_kind", "text"],
  ["archive_operation_batches.batch_ordinal", "int8"],
  ["archive_operation_batches.record_count", "int8"],
  ["archive_operation_batches.batch_fingerprint", "bpchar"],
  ["archive_operation_batches.chain_binding", "bpchar"],
  ["archive_operation_batches.actor", "name"],
  ["archive_operation_batches.created_at", "timestamptz"],
  ["archive_import_records.sequence", "int8"],
  ["archive_import_records.request_id", "uuid"],
  ["archive_import_records.record_kind", "text"],
  ["archive_import_records.record_key", "text"],
  ["archive_import_records.batch_ordinal", "int8"],
  ["archive_import_records.semantic_fingerprint", "bpchar"],
  ["archive_import_records.inserted", "bool"],
  ["archive_import_records.actor", "name"],
  ["archive_import_records.created_at", "timestamptz"],
  ["archive_transaction_authorizations.backend_pid", "int4"],
  ["archive_transaction_authorizations.transaction_id", "text"],
  ["archive_transaction_authorizations.request_id", "uuid"],
  ["archive_transaction_authorizations.operation", "text"],
  ["archive_transaction_authorizations.workspace", "text"],
  ["archive_transaction_authorizations.client_verified_digest", "bpchar"],
  ["archive_transaction_authorizations.actor", "name"],
  ["archive_transaction_authorizations.messages_consumed", "bool"],
  ["archive_transaction_authorizations.receipts_consumed", "bool"],
  ["archive_transaction_authorizations.created_at", "timestamptz"],
  ["portable_archive_attestations.name", "text"],
  ["portable_archive_attestations.catalog_definition", "text"],
  ["portable_archive_attestations.attested_at", "timestamptz"],
